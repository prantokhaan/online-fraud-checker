...
$query = "SELECT id, sellerName, courierName, sellerFBLink, complainStatus, created_at FROM sellerComplain WHERE LOWER(complainStatus) = 'accepted'";
                    ...
                    <?php if (count($complaints) > 0): ?>
                        <?php foreach ($complaints as $complaint): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($complaint['sellerName']); ?></td>
                                <td><?php echo htmlspecialchars($complaint['courierName']); ?></td>
                                <td><a href="<?php echo htmlspecialchars($complaint['sellerFBLink']); ?>" target="_blank">View FB Profile</a></td>
                                <td>
                                    <?php
